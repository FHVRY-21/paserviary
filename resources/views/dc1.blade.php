...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/eliteadmin-ecommerce/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2017 17:03:36 GMT -->
<head>
<meta charset="utf-8">
...
<!-- Custom CSS -->
<link href="{{ url('css/stylee.css')}}" rel="stylesheet">

<!-- color CSS -->
<link href="{{ url('css/colors/default.css')}}" rel="stylesheet">
      ...
      <ul class="nav navbar-top-links navbar-right pull-right">
        ...
        <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="ti-shopping-cart"></i>
          ...
          <ul class="dropdown-menu dropdown-cart dropdown-tasks animated slideInUp">
            ...
            <li class="divider"></li>
            <li> <a class="text-center" href="product-checkout.html"> <strong>Checkout</strong> <i class="fa fa-angle-right"></i> </a> </li>
          </ul>
          <!-- /.dropdown-tasks -->
        </li>
        <!-- /.dropdown -->
          ...
          <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
            ...
            <li class="col-sm-12 m-t-40 demo-box">
               <div class="row">
                  ...
                  <div class="col-sm-2"><div class="white-box text-center bg-info"><a href="index.html" target="_blank" class="text-white"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i><br/>Demo 3</a></div></div>
                  ...
                  <div class="col-sm-2"><div class="white-box text-center bg-danger"><a href="../../../themeforest.net/item/elite-admin-the-ultimate-dashboard-web-app-kit-material-design/16750820.html" target="_blank" class="text-white"><i class="linea-icon linea-ecommerce fa-fw" data-icon="d"></i><br/>Buy Now</a></div></div>
               </div>     
            </li>
          </ul>
        </li>
    ...
    <div class="container-fluid">
      <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
          <a href="../../../themeforest.net/item/elite-admin-the-ultimate-dashboard-web-app-kit-material-design/16750820.html" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Buy Now</a>
          <ol class="breadcrumb">
...
<!-- /#wrapper -->
<!-- jQuery -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/jquery/dist/jquery.min.js') }}"></script>
<!-- Bootstrap Core JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<!-- Menu Plugin JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js') }}"></script>
<!--slimscroll JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/js/jquery.slimscroll.js') }}"></script>
<!--Wave Effects -->
<script type="text/javascript" src="{{ URL::asset('lol/js/waves.js') }}"></script>
<!--Counter js -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/waypoints/lib/jquery.waypoints.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/counterup/jquery.counterup.min.js') }}"></script>
<!--Morris JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/raphael/raphael-min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/morrisjs/morris.js') }}"></script>
<!-- Custom Theme JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/js/custom.min.js') }}"></script>
<!-- Sparkline chart JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/jquery-sparkline/jquery.charts-sparkline.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('lol/js/dashboard1.js') }}"></script>
<!-- Sparkline chart JavaScript -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/jquery-sparkline/jquery.charts-sparkline.js') }}"></script>

<!--Style Switcher -->
<script type="text/javascript" src="{{ URL::asset('lol/plugins/bower_components/styleswitcher/jQuery.style.switcher.js') }}"></script>
</body>

<!-- Mirrored from eliteadmin.themedesigner.in/demos/eliteadmin-ecommerce/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2017 17:05:35 GMT -->
</html>
