              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ url('/settingusr')}}" class="btn btn-default btn-flat">Profile</a>
                    </div>
...
<!-- /.box -->
          ...
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Hasil Produksi</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ url('/updateprdks')}}">
                  <div class="box-body">
  ...
  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="nama_barang" value="{{ $data->nama_barang }}">  </input> 
                    <input type="hidden" name="id" value="{{$data->id}}">     
                  </div>
                  <br>
                      <div class="form-group">
                      <label >Kategori</label>
                      <select class="form-control" name="kategori" value="{{ $data->nama_kategori}}">
                        <option>Buah</option>
                        <option>Sayur</option>
                        <option>Jamur</option>
                    ...
                    <div class="input-group" value="{{ $data->tgl_panen }}">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <input type="text" class="form-control" data-inputmask="'alias': 'hh/bb/tttt'" data-mask>
                    </div><!-- /.input group -->
  ...
  <div class="input-group">                  
                  ...
                  <br>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="image" id="exampleInputFile" value="{{ $data->image }}">
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" formmethod="POST" action="{{ url('/updateprdks')}}">Submit</button>
                  </div>
                </form>
              </div>
        </section><!-- /.content -->
