...
<!-- /.box -->
          ...
          <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="/updateprdks">
                  <div class="box-body">
  ...
  <div class="input-group">
                    ...
                    <span class="input-group-addon"><i class="fa fa-leaf"></i></span>
                    <input type="password" class="form-control" name="password" value="{{ \Auth::user()->password }}">  </input>
                                      <label for="exampleInputEmail1">Konfirmasi Password</label>
  <div class="input-group">
                     
                    <span class="input-group-addon"><i class="fa fa-leaf"></i></span>
                    <input type="pasword" class="form-control" name="" value="">  </input>
                  </div>
                  </div>
  ...
  <div class="input-group">
                    ...
                    <span class="input-group-addon"><i class="fa fa-leaf"></i></span>
                    <input type="text" class="form-control" name="no_rekening" value="">  </input>
                  </div>
