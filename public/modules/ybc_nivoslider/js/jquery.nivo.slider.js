...
(function($) {
    var NivoSlider = function(element, options){
        ...
        var processCaption = function(settings){
            ...
            {
                var ybcCaption = '<div class="ybc-caption-frame animation-type-'+captionAnimation+' '+customClass+'" style="width:'+settings.textFrameWidth+';"><div data-title="'+captionTop+'" class="ybc-caption '+captionPosition+' '+captionTextDirection+'" style="top: '+captionTop+';margin-left: '+captionLeft+';margin-right: '+captionRight+'; width: '+captionWidth+';">' + caption1 + caption2 + caption4 +  caption3 + '</div></div>';
